...
@WebServlet(name = "SearchViaYear", urlPatterns = {"/SearchViaYear"})
public class SearchViaYear extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<VehiclesPublic> SearchResults = VehiclesPublicDB.getAllPublicVehiclesViaMake(Year);
