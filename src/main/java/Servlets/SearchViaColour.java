...
@WebServlet(name = "SearchViaColour", urlPatterns = {"/SearchViaColour"})
public class SearchViaColour extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String Colour = request.getParameter("searchTerm");
            
            
            //Make a List of Vehicles from the Database. 
            List<VehiclesPublic> SearchResults = VehiclesPublicDB.getAllPublicVehiclesViaColour(Colour);
