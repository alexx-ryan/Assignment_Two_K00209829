...
@WebServlet(name = "SearchViaListingNumber", urlPatterns = {"/SearchViaListingNumber"})
public class SearchViaListingNumber extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String ListingNumber = request.getParameter("searchTerm");


            //Make a List of Vehicles from the Database. 
            List<VehiclesPublic> SearchResults = VehiclesPublicDB.getAllPublicVehiclesViaListingNumber(ListingNumber);
