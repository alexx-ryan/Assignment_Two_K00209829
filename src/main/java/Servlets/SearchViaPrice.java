...
@WebServlet(name = "SearchViaPrice", urlPatterns = {"/SearchViaPrice"})
public class SearchViaPrice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String Price = request.getParameter("searchTerm");
            
            
            //Make a List of Vehicles from the Database. 
            List<VehiclesPublic> SearchResults = VehiclesPublicDB.getAllPublicVehiclesViaMake(Price);
