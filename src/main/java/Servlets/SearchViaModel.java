...
@WebServlet(name = "SearchViaModel", urlPatterns = {"/SearchViaModel"})
public class SearchViaModel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String Model = request.getParameter("searchTerm");
            
            
            //Make a List of Vehicles from the Database. 
            List<VehiclesPublic> SearchResults = VehiclesPublicDB.getAllPublicVehiclesViaMake(Model);
