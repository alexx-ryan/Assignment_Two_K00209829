...
public class ViewVehicle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //Get Variable from request. (In this case the image link)
            String listingNumber = request.getParameter("searchTerm");                      
           
            
            
            //Make a List of Vehicles from the Database. 
            VehiclesPublic SearchResults = VehiclesPublicDB.getPublicVehicleViaListingNumber(listingNumber);
                           
            //URL of next page JSP View.
            String nextpage = "/ViewVehicle.jsp";
