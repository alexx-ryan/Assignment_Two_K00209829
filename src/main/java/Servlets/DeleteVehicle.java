...
public class DeleteVehicle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String thisVehicle = request.getParameter("deleteVehicle");                
            
            //Get the employee details using the employeeName. 
            VehiclesPublic DeleteVehicle = VehiclesPublicDB.getPublicVehicleViaListingNumber(thisVehicle);
            
            //Call Delete Method on this employee.
            VehiclesPublicDB.DeleteVehicle(DeleteVehicle);
